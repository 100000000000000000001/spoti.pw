...
# the host app needs for the widget's buttons.
#
...
SHARED="$ROOT/tweak/Sources/Features/LiveActivity/LiveActivityShared.swift"
...
# The buttons' intents run inside Spotify, so Spotify's metadata has to name them too, under the
