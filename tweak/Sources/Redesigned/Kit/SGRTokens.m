...
UIColor *SGRAccent(void) {
    return SGAccentColor() ?: [UIColor colorWithRed:0x1E / 255.0 green:0xD7 / 255.0 blue:0x60 / 255.0 alpha:1];
}
...
UIColor *SGRElevated(UIColor *field) {
    ...
    // 12% towards white keeps a card on a black AMOLED field clear of the greys Amoled.x turns black.
    CGFloat lift = 0.12;
